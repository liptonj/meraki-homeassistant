...
if (!document.querySelector('script[type="importmap"]')) {
  ...
  importMap.textContent = JSON.stringify({
    imports: {
      ...
      'lit-element':
        'https://cdn.jsdelivr.net/npm/lit-element@4.0.2/lit-element.js',
      ...
      '@lit/reactive-element':
        'https://cdn.jsdelivr.net/npm/@lit/reactive-element@2.0.2/reactive-element.js',
      '@lit/reactive-element/':
        'https://cdn.jsdelivr.net/npm/@lit/reactive-element@2.0.2/',
    },
  });
...
// Now import the main cards bundle and dashboard strategy
Promise.all([
  import('./meraki-cards.js'),
  import('./meraki-dashboard-strategy.js'),
])
  .then(() => {
    console.info(
      '%c MERAKI CARDS ',
      'color: #fff; background: #2980b9; font-weight: 700; padding: 4px 8px; border-radius: 4px;',
      'All cards and strategy loaded successfully'
    );
  })
  .catch((err) => {
    console.error('Failed to load Meraki resources:', err);
  });
